...
const API_URL = import.meta.env.VITE_API_URL; // Make sure to set this in your env file

export default function EffectCardThree() {
  ...
  useEffect(() => {
    ...
    fetch(`${API_URL}/trips/romantic-escapes`)
      .then((res) => {
  ...
  return (
    <div id="app" className="block md:hidden bg-[#E5F8FF] px-0 pt-3 pb-5">
      {/* Heading + SVG row */}
